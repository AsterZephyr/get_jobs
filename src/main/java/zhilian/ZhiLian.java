...
public class ZhiLian {
    ...
    private static String getSearchUrl(String keyword, int page) {
        return homeUrl +
                ...
                JobUtils.appendParam("et", config.getType()) +
    ...
    private static void setMaxPages() {
        ...
        while (true) {
            try {
                ...
                // 问题
                //
                // WebElement button = CHROME_DRIVER.findElement(By.xpath("//button[@class='btn soupager__btn']"));
                WebElement button = CHROME_DRIVER.findElement(By.className("btn soupager__btn soupager__btn--disable"));
